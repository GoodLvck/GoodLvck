...
class Pagination
{
    ...
    private function _getStartLink()
    {
        if ($this->_offset == 0) {
            $active = false;
            $data = '<span>Start</span>';
        } else {
            $active = true;
            $startHref = JURI::root(true) . $this->_pageLink . '&offset=0';
            $data = '<a title="Start" href="' . $startHref . '">Start</a>';
        }
        return array(
            'active' => $active,
            'data' => $data,
    ...
    private function _getPreviousLink()
    {
        if ($this->_offset == 0) {
            ...
            $data = '<a title="Prev" href="' . $previousHref . '">Prev</a>';
        }
        return array(
            'active' => $active,
            'data' => $data,
    ...
    private function _getNextLink()
    {
        ...
        if ($nextLimitStart > $this->_allPosts) {
            ...
            $data = '<a title="Next" href="' . $nextHref . '">Next</a>';
        }
        return array(
            'active' => $active,
            'data' => $data,
    ...
    private function _getEndLink()
    {
        ...
        if ($endLimitStart > $this->_allPosts) {
            ...
            $data = '<a title="End" href="' . $endHref . '">End</a>';
        }
        return array(
            'active' => $active,
            'data' => $data,
