<!--product_item-->
      <div class="u-align-center u-container-style u-products-item<?php echo $productItemInvisible0 ? ' u-invisible' : ''; ?> u-repeater-item u-white u-repeater-item-1">
        <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1"><!--product_image-->
          <?php if ($image0) : ?><a class="u-expanded-width u-image u-image-default u-product-control u-image-1" href="<?php $link = $titleLink0 ? $titleLink0 : ''; if($link): echo $link; endif; ?>"><img alt="" class="u-expanded-width u-image u-image-default u-product-control u-image-1" src="<?php echo $image0; ?>"></a><?php else: ?><div class="none-post-image" style="display: none;"></div><?php endif; ?><!--/product_image--><!--product_title-->
...
?>
          ...
          <?php if ($productButtonText0): ?><?php if ($productButtonHtml0 && $clickTypeProductbutton != 'go-to-page'): ?>
                        <?php $productButtonLink0 = '#'; ?>
                        <?php ob_start(); ?>
                        ...
                        ?>
                        <?php else: ?>
                    <a href="<?php echo $productButtonLink0; ?>" class="u-border-2 u-border-grey-25 u-btn u-btn-rectangle u-button-style u-none u-product-control u-text-body-color u-btn-1"><?php echo $productButtonText0; ?></a><?php endif; ?><?php endif; ?>
        </div>
