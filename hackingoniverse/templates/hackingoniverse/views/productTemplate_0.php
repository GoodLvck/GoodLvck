<?php ob_start(); ?>
<section class="u-align-center u-clearfix u-section-1" id="sec-bffc">
...
?>
        ...
        <?php if ($productButtonText0): ?><?php if ($productButtonHtml0 && $clickTypeProductbutton != 'go-to-page'): ?>
                        ...
                        ?>
                        <?php else: ?>
                    <a href="<?php echo $productButtonLink0; ?>" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-product-control u-text-black u-text-hover-white u-btn-1"><?php echo $productButtonText0; ?></a><?php endif; ?><?php endif; ?>
      </div>
