...
$menu_html = buildMenu($list, $default_id, $active_id, $path, array(
		...
		'menu_class' => 'u-custom-font u-nav u-spacing-20 u-unstyled u-nav-1',
		'item_class' => 'u-nav-item',
		'link_class' => 'u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-palette-1-light-1',
